...
//        flag = new int[widthInCharacters][heightInCharacters];
    ...
    public void paint(Graphics g) {
        ...
        for (int x = 0; x < widthInCharacters; x++) {
            for (int y = 0; y < heightInCharacters; y++) {
                ...
                Color fg = foregroundColors[x][y];//此处忽略了前景色

                offscreenGraphics.setColor(bg); // 设置背景色
                offscreenGraphics.fillRect(x * charWidth, y * charHeight, charWidth, charHeight); // 填充背景色
