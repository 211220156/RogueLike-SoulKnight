...
public class AsciiFont {
    ...
    public static final AsciiFont Gold_plated_16x16 = new AsciiFont("Gold_plated_16x16.png", 16, 16);
    public static final AsciiFont Gold_plated_32x32 = new AsciiFont("Gold_plated_32x32.png", 32, 32);
