...
public class AsciiPanelTest {
    ...
    public void testClear1() {
        AsciiPanel panel = new AsciiPanel(10, 10, AsciiFont.Gold_plated_32x32);
        panel.clear();
    }
    @Test(expected = IllegalArgumentException.class)
    ...
    public void testClear3() {
        AsciiPanel panel = new AsciiPanel(10, 10, AsciiFont.Gold_plated_32x32);
        panel.clear((char) 0, -1, 0, 5, 5);
    }
    @Test
    public void testWithEachTile() {
        AsciiPanel panel = new AsciiPanel(10, 10, AsciiFont.Gold_plated_32x32);
        panel.withEachTile(1, 1, 10, 10, (x, y, data) -> {
